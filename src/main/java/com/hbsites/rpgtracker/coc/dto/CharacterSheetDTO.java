...
public class CharacterSheetDTO {
    ...
    private List<CharacterSheetSkillDTO> skills = new ArrayList<>();
    private @NonNull List<PulpTalentDTO> pulpTalents;
    private OccupationDetailDTO occupation;
    private @NonNull List<CharacterSheetWeaponDTO> weapons;
    private @NonNull List<CharacterSheetSpellDTO> spells;
